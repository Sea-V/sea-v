      ...
      if (!r) {
        ...
        dashRefSnippet.innerHTML = `
          <div class="list">
            <div class="list-row">
              <div style="min-width:0;">
                <div class="list-title">${Seav.escapeHtml(r.name)} <span class="muted">(${Seav.escapeHtml(getReferenceStatus(r))})</span></div>
              ...
              <span class="pill">${Seav.escapeHtml(getReferenceStatus(r))}</span>
            </div>
          </div>`;
      }
    }
