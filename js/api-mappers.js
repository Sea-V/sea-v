...
function mapVesselToSupabase(item) {
  ...
  function mapSeatimeFromSupabase(s) {
    return {
      ...
      locationJoined: s.location_joined || "",
      locationLeft: s.location_left || "",
  ...
  function mapSeatimeToSupabase(item) {
    return {
      ...
      location_joined: item.locationJoined || "",
      location_left: item.locationLeft || "",
  ...
  function mapCertFromSupabase(c) {
    return {
      ...
      trainingProvider: c.training_provider || "",
  ...
  function mapCertToSupabase(item) {
    return {
      ...
      code: item.code || "",
      name: item.name || "",
      issue_date: item.issued || "",
      expiry_date: item.expiry || "",
      status: item.status || "",
      issuing_authority: item.issuingAuthority || "",
      training_provider: item.trainingProvider || "",
...
function mapOnboardExperienceToSupabase(item) {
  return {
    ...
    position_held: item.positionHeld || "",
